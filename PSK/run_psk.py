# Script to run the 16-PSK PINN training and evaluation process for reinforcement learning.
...
with open("pinn_psk.log", "w") as log_file: # Clear log file at the start of each run
    log_file.write("")

logger.log(logging.INFO, "Log saved as pinn_psk.log in current working directory.")

from pinn_psk import assertlog, str2bool

def main():
    parser = argparse.ArgumentParser(description="Run 16-PSK PINN Training and Evaluation with Reinforcement Learning.")
    ...
    parser.add_argument("--script_path", type=str, default="PSK/pinn_psk.py", help="String. Path to the 16-PSK PINN training script. Default 'PSK/pinn_psk.py'.")
