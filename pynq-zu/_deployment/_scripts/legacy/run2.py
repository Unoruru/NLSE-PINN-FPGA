...
def safe_load_pickle(pkl_path: Path):
    ...
    try:
        ...
        try:
            return pickle.load(str(pkl_path))
        except Exception as e:
            raise
...
def main():
    ...
    # optionally load and inspect pickle (NEEDS UPDATE TO REMOVE INSPECTION CODE AND JUST LOAD FOR USE IN EXECUTION)
    ...
    # run defaults if inputs not provided
        ...
        # manually create input array (z, t) from t=-10:10 (inclusive)        
        # inp = [
