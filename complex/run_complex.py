...
with open("pinn_complex.log", "w") as log_file: # Clear log file at the start of each run
    log_file.write("")

logger.log(logging.INFO, "Log saved as pinn_complex.log in current working directory.")

from pinn_complex import assertlog, str2bool
...
def main():
    ...
    parser.add_argument("--script_path", type=str, default="complex/pinn_complex.py", help="String. Path to the complex PINN training script. Default 'pinn_complex.py'.")
    ...
    os.system("python " + args.script_path + " --load True --reinforce True --visual False --epochs {}".format(args.epochs))
    ...
    os.system("python " + args.script_path + " --load True --onnx_export False --finn_convert False")
